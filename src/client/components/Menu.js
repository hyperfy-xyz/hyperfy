...
export function MenuItemColorWheel({ label, hint, value, onChange }) {
  ...
  // Convert hex to HSL for color wheel calculations
  const hexToHsl = (hex) => {
  ...
  const currentHsl = hexToHsl(localValue)
  ...
  const handleWheelClick = (e) => {
    ...
    const newHex = hslToHex(hue, saturation, currentHsl.l)
  ...
  return (
    <label
      className='menuitemcolorwheel'
      css={css`
        display: block;
        position: relative;
        .menuitemcolorwheel-control {
          display: flex;
          align-items: center;
          height: 2.5rem;
          padding: 0 0.875rem;
        ...
        .menuitemcolorwheel-preview {
          display: flex;
          align-items: center;
          gap: 0.5rem;
        }
        .menuitemcolorwheel-swatch {
          width: 1.5rem;
          height: 1.5rem;
          border-radius: 0.25rem;
          border: 1px solid rgba(255, 255, 255, 0.2);
        }
        .menuitemcolorwheel-text {
          font-family: monospace;
          text-transform: uppercase;
        }
        .menuitemcolorwheel-control:hover {
          background-color: rgba(255, 255, 255, 0.05);
        }
        .menuitemcolorwheel-picker {
          position: absolute;
          top: 100%;
          right: 0;
          z-index: 1000;
        ...
        .menuitemcolorwheel-wheel::before {
          content: '';
          position: absolute;
          inset: 0;
        ...
        .menuitemcolorwheel-wheel::after {
          content: '';
          position: absolute;
          inset: 0;
          pointer-events: none;
        }
        .menuitemcolorwheel-pointer {
          position: absolute;
          width: 12px;
          height: 12px;
        ...
        .menuitemcolorwheel-lightness {
          margin-top: 1rem;
          display: flex;
          align-items: center;
          gap: 0.5rem;
        }
        .menuitemcolorwheel-lightness-label {
          font-size: 0.75rem;
          color: rgba(255, 255, 255, 0.6);
          width: 1rem;
        }
        .menuitemcolorwheel-lightness-slider {
          flex: 1;
          height: 0.5rem;
        ...
        .menuitemcolorwheel-lightness-slider::-webkit-slider-thumb {
          -webkit-appearance: none;
          appearance: none;
          width: 1rem;
          height: 1rem;
        ...
        .menuitemcolorwheel-lightness-slider::-moz-range-thumb {
          width: 1rem;
          height: 1rem;
          background: white;
          border-radius: 50%;
    ...
    >
      <div 
        className='menuitemcolorwheel-control'
        onClick={() => setShowPicker(!showPicker)}
        style={{ border: '1px solid red' }}
      >
        <div className='menuitemcolorwheel-label' style={{ color: 'white' }}>{label || 'NO LABEL'}</div>
        <div className='menuitemcolorwheel-preview'>
          <div 
            className='menuitemcolorwheel-swatch' 
            style={{ backgroundColor: localValue, border: '1px solid white' }}
          />
          <div className='menuitemcolorwheel-text' style={{ color: 'white' }}>{localValue}</div>
        </div>
      </div>
      
      {showPicker && (
        <div className='menuitemcolorwheel-picker' ref={pickerRef}>
          <div 
            className='menuitemcolorwheel-wheel'
          ...
          >
            <div 
              style={{
                position: 'absolute',
                inset: 0,
                background: `radial-gradient(circle, transparent 0%, rgba(0, 0, 0, ${1 - currentHsl.l / 100}) 100%)`,
                pointerEvents: 'none'
              }}
            />
            <div 
              className='menuitemcolorwheel-pointer'
              style={{
                left: `${50 + (currentHsl.s / 100) * 50 * Math.cos(currentHsl.h * Math.PI / 180)}%`,
                top: `${50 + (currentHsl.s / 100) * 50 * Math.sin(currentHsl.h * Math.PI / 180)}%`,
                backgroundColor: localValue
              }}
            />
          </div>
          <div className='menuitemcolorwheel-lightness'>
            <div className='menuitemcolorwheel-lightness-label'>L</div>
            <input
              type='range'
              className='menuitemcolorwheel-lightness-slider'
              min='0'
              max='100'
              value={currentHsl.l}
