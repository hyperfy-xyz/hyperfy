...
export function createNodeClientWorld() {
  ...
  // world.register('loader', ClientLoader) // TODO: ClientLoader should be named BrowserLoader and ServerLoader should be called NodeLoader
  ...
  // world.theregister('target', ClientTarget)
